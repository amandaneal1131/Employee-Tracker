    ...
    inquirer
        ...
        .then(employeeInfo => {
            ...
            inquirer
                ...
                .then(managerInfo => {
                    let empID = employees.find(obj => obj.name === employeeInfo.empName)
                        .id;
...
async function addRole() {
    ...
    inquirer
        ...
        .then(answers => {
            let depID = departments.find(obj => obj.name === answers.roleDepartment)
                .id;
        ...
        .then(response => {
            ...
            inquirer
                ...
                .then(answers => {
                    ...
                    db.query(
                        'UPDATE role SET title=?, salary=?, department_id=? WHERE id=?', [response.roleName, answers.salaryNum, depID, roleID]
                    );
...
// Title screen on app start. Nice ASCII art
console.log(
    '_______  __   __  _______    _______  ______    _______  _______  ___   _  _______  ______\n|       ||  |_|  ||       |  |       ||    _ |  |   _   ||       ||   | | ||       ||    _ |\n|       ||       ||  _____|  |_     _||   | ||  |  |_|  ||       ||   |_| ||    ___||   | ||\n|       ||       || |_____     |   |  |   |_||_ |       ||       ||      _||   |___ |   |_||_ \n|      _||       ||_____  |    |   |  |    __  ||       ||      _||     |_ |    ___||    __  |\n|     |_ | ||_|| | _____| |    |   |  |   |  | ||   _   ||     |_ |    _  ||   |___ |   |  | |\n|_______||_|   |_||_______|    |___|  |___|  |_||__| |__||_______||___| |_||_______||___|  |_|\n\nVersion Almost\n'
);
